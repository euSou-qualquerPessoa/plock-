...
local Window = OrionLib:MakeWindow({Name = "Desplock Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Desplock Hub"})
...
W:AddLabel("[+] Desplock Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Desplock Hub(Noitification)",
